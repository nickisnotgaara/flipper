// Column defs + filter defs for the "Дома" sheet of the tables page.

import type { ColumnDef } from '@tanstack/react-table';
import type { FilterDef } from '@/components/admin/FilterPanel';

export const HOUSES_TOTAL = 30_868;

export const housesFilters: FilterDef[] = [
  {
    key: 'source',
    label: 'Источник',
    group: 'Категории',
...
export const housesColumns: ColumnDef<any, any>[] = [
  {
    id: 'address',
    header: 'Адрес',
    accessorKey: 'address',
