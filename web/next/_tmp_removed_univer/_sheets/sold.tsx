// Column defs + filter defs for the "Снято" sheet of the tables page.
...
export const SOLD_TOTAL = 18_375;

export const soldFilters: FilterDef[] = [
  {
    key: 'rooms',
    label: 'Комнат',
    group: 'Категории',
...
export const soldColumns: ColumnDef<any, any>[] = [
  {
    id: 'title',
    header: 'Адрес / ID',
    accessorKey: 'title',
