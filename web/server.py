...
_TABLE_COLUMNS = {
    "active": [
        {"key": "id", "label": "ID", "type": "number", "editable": False, "width": 72},
        {"key": "source", "label": "Источник", "type": "text", "editable": False, "width": 100},
        {"key": "external_id", "label": "cian_id", "type": "text", "editable": False, "width": 100},
        {"key": "title", "label": "Заголовок", "type": "text", "editable": False, "width": 280},
        {"key": "url", "label": "Ссылка", "type": "url", "editable": False, "width": 260},
        {"key": "price", "label": "Цена", "type": "number", "editable": False, "width": 130},
        {"key": "price_per_m2", "label": "Цена/м²", "type": "number", "editable": False, "width": 110},
        {"key": "area", "label": "Площадь", "type": "number", "editable": False, "width": 90},
        {"key": "rooms", "label": "Комнат", "type": "number", "editable": False, "width": 80},
        {"key": "floor_current", "label": "Этаж", "type": "number", "editable": False, "width": 70},
        {"key": "floor_total", "label": "Этажей", "type": "number", "editable": False, "width": 70},
        {"key": "district", "label": "Район", "type": "text", "editable": True, "width": 170},
        {"key": "okrug", "label": "Округ", "type": "text", "editable": True, "width": 130},
        {"key": "metro_station", "label": "Метро", "type": "text", "editable": True, "width": 170},
        {"key": "metro_walk_time", "label": "До метро, мин", "type": "number", "editable": True, "width": 90},
        {"key": "renovation", "label": "Ремонт", "type": "text", "editable": True, "width": 150},
        {"key": "days_in_exposition", "label": "Дней на сайте", "type": "number", "editable": False, "width": 100},
        {"key": "publish_date", "label": "Опубликовано", "type": "date", "editable": False, "width": 120},
        {"key": "filter_id", "label": "Фильтр", "type": "number", "editable": True, "width": 80},
        {"key": "house_id", "label": "Дом", "type": "number", "editable": False, "width": 80},
    ],
    "sold": [
        {"key": "id", "label": "ID", "type": "number", "editable": False, "width": 72},
        {"key": "source", "label": "Источник", "type": "text", "editable": False, "width": 100},
        ...
        {"key": "rooms", "label": "Комнат", "type": "number", "editable": False, "width": 80},
        {"key": "renovation", "label": "Ремонт", "type": "text", "editable": True, "width": 150},
        {"key": "sold_date", "label": "Продано", "type": "date", "editable": False, "width": 120},
        {"key": "days_in_exposition", "label": "Дней на сайте", "type": "number", "editable": False, "width": 100},
        {"key": "house_id", "label": "Дом", "type": "number", "editable": False, "width": 80},
    ],
    "hidden": [
        ...
        {"key": "rooms", "label": "Комнат", "type": "number", "editable": False, "width": 80},
        {"key": "renovation", "label": "Ремонт", "type": "text", "editable": True, "width": 150},
        {"key": "sold_date", "label": "Снято", "type": "date", "editable": False, "width": 120},
        {"key": "days_in_exposition", "label": "Дней на сайте", "type": "number", "editable": False, "width": 100},
        {"key": "house_id", "label": "Дом", "type": "number", "editable": False, "width": 80},
    ],
    "houses": [
        {"key": "id", "label": "ID", "type": "number", "editable": False, "width": 72},
        {"key": "source", "label": "Источник", "type": "text", "editable": False, "width": 120},
        {"key": "address", "label": "Адрес", "type": "text", "editable": True, "width": 300},
        {"key": "street", "label": "Улица", "type": "text", "editable": True, "width": 180},
        {"key": "house_num", "label": "Дом", "type": "text", "editable": True, "width": 80},
        {"key": "year", "label": "Год постройки", "type": "number", "editable": True, "width": 110},
        {"key": "levels", "label": "Этажей", "type": "number", "editable": True, "width": 80},
        {"key": "type", "label": "Тип", "type": "text", "editable": True, "width": 130},
        {"key": "series", "label": "Серия", "type": "text", "editable": True, "width": 130},
        {"key": "lat", "label": "Широта", "type": "number", "editable": False, "width": 110},
        {"key": "lng", "label": "Долгота", "type": "number", "editable": False, "width": 110},
        {"key": "active_count", "label": "Активных", "type": "number", "editable": False, "width": 100},
        {"key": "deactivated_count", "label": "Снято", "type": "number", "editable": False, "width": 100},
    ],
    ...
    "filters": [
        {"key": "id", "label": "ID", "type": "number", "editable": False, "width": 72},
        {"key": "external_id", "label": "cian_id", "type": "text", "editable": False, "width": 110},
        {"key": "url", "label": "URL парсера", "type": "url", "editable": False, "width": 460},
        {"key": "filter_id", "label": "Фильтр", "type": "number", "editable": False, "width": 80},
        {"key": "source", "label": "Источник", "type": "text", "editable": False, "width": 110},
        {"key": "district", "label": "Район", "type": "text", "editable": False, "width": 170},
        {"key": "price", "label": "Цена", "type": "number", "editable": False, "width": 130},
    ],
    "avans": [
        {"key": "id", "label": "ID", "type": "number", "editable": False, "width": 72},
