...
# Импортируем фикстуру из общего conftest
from packages.flipper_db.tests.conftest import repo  # noqa: F401

# Пере-экспортируем, чтобы pytest её нашёл
__all__ = ["repo"]


@pytest_asyncio.fixture
async def cian_active_repo(repo):
    """alias для ясности в тестах cian_active."""
    return repo


# ============================================================ AdParser fixtures
# (для tests/test_acquirer.py)
