"""
services.parsers.cian_active.acquirer.cards - AdParser for self-hosted Flippercrawl integration
...
from services.parsers.cian_active.acquirer.models import ParsedAdData
...
class AdParser:
    ...
    def __init__(
        ...
        """
        self.api_key = (
            flippercrawl_api_key
            or os.getenv("FLIPPERCRAWL_API_KEY")
            or "test-key"
        ).strip()

        base = (
            flippercrawl_base_url
            or os.getenv("FLIPPERCRAWL_BASE_URL")
