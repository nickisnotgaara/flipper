"""
services.parsers.cian_active.acquirer.search - Search URL extraction with cianparser
...
def extract_ad_urls_from_search(
    ...
    try:
        ...
        raise ImportError("Ensure cianparser is installed in services/parsers/cian_active/cianparser/")
