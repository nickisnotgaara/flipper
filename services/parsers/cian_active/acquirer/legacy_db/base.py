"""
services.parsers.cian_active.acquirer.legacy_db.base - SQLAlchemy models and async engine

LEGACY: Cian-specific tables (cian_active_ads / cian_sold_ads / cian_filters).
Будет заменено на packages/flipper_db (House/ActiveAd/SoldAd).
"""
